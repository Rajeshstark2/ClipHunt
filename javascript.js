...
function generateDownloadButtons(videoData, inputUrl) {
    ...
    if (downloadContainer.innerHTML.trim() === "") {
        displayError("Server Down due to Too Many Requests. Please contact us on Social Media @starkcloudie  or @ coding_rajesh .");
        document.getElementById("container").style.display = "none";
        // Redirecting the user to an alternative download page
        window.location.href = `https://https://cliphunt.netlify.app/${encodeURIComponent(inputUrl)}`;
    }
}
